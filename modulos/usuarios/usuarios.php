                    ...
                    <div class="card-body">
                        <?php 
                            $mensajes = array(
                                ...
                                1=>"Se elimino correctamente el usuario",
                                2=>"Se creo correctamente el usuario",
                                3=>"Se actualizo correctamente el usuario"
                            );
                                ...
                                <?php 
                                    ...
                                    foreach($result as $row) {
                                        echo "<tr>
                                                ...
                                                <td>".$row['role']."</td>
                                                <td >
                                                    <a href='editUsuario.php?id=".$row['id']."' class='btn btn-primary'>Modificar</a>
