...
<body>
    ...
    <?php include_once('../../administrador/menu.php'); ?>
            ...
            <div class="col-sm-8 col-xl-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        Listado de Roles
                        <a href="<?= ROOT ?>modulos/roles/addRol.php" class="btn btn-primary">Crear Roles</a>
                    </div>
                    <div class="card-body">
                        <?php 
                            $mensajes = array(
                                0=>"No se pudo realizar la acción, comunicate con el administrador",
                                1=>"Se elimino correctamente el rol",
                                2=>"Se creo correctamente el rol",
                                3=>"Se actualizo correctamente el rol"
                            );
                                ...
                                <?php 
                                    ...
                                    foreach($result as $row) {
                                        echo "<tr>
                                                ...
                                                <td>".$row['nombre']."</td>
                                                <td>
                                                    <a href='editRol.php?id=".$row['id']."' class='btn btn-primary'>Modificar</a>
